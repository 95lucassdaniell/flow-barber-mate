-- PLANO COMPLETO: Gerar dados históricos completos para Barberia Vargas (CORRIGIDO)
...
-- FASE 2: Buscar IDs reais de barbeiros e serviços
-- Vamos buscar os IDs corretos primeiro
DO $$
DECLARE
  barber_ids uuid[];
  service_ids uuid[];
...
-- FASE 4: Aguardar triggers automáticos criarem comandos
PERFORM pg_sleep(2);

-- FASE 5: Fechar comandos dos agendamentos concluídos
...
WHERE barbershop_id = '9ccfd4a2-3bc1-41be-933b-51e94d0dc29a'::uuid
AND status = 'open'
...
-- FASE 6: Criar vendas para comandos fechados
...
WHERE c.barbershop_id = '9ccfd4a2-3bc1-41be-933b-51e94d0dc29a'::uuid
AND c.status = 'closed'
