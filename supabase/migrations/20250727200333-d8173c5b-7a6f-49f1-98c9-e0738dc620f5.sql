-- Povoar todas as comandas zeradas restantes
DO $$
DECLARE
    comando RECORD;
    servico_id uuid;
    ...
    contador integer := 0;
BEGIN
    -- Processar TODAS as comandas com total_amount = 0
    FOR comando IN 
    ...
    RAISE NOTICE 'Processadas % comandas restantes com sucesso!', contador;
END $$;