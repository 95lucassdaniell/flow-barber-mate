...
INSERT INTO public.whatsapp_templates (barbershop_id, name, content, variables, category, trigger_type) VALUES
...
Aguardamos você! 😊', 
ARRAY['client_name', 'appointment_date', 'appointment_time', 'barber_name', 'service_name', 'total_price', 'barbershop_name', 'barbershop_address'], 
...
ARRAY['client_name', 'appointment_date', 'appointment_time', 'barber_name', 'service_name', 'barbershop_name', 'barbershop_address'], 
...
ARRAY['client_name', 'appointment_time', 'barber_name', 'service_name', 'barbershop_name', 'barbershop_address'], 
'appointment_reminder', 'appointment_reminder_1h'),
...
{{barbershop_name}}', 
ARRAY['client_name', 'appointment_date', 'appointment_time', 'barber_name', 'barbershop_name'], 
'appointment_cancellation', 'appointment_cancelled');
...
SELECT 
  ...
  t.id,
  CASE 
    WHEN t.trigger_type = 'appointment_created' THEN 0
    WHEN t.trigger_type = 'appointment_reminder_24h' THEN 0
    WHEN t.trigger_type = 'appointment_reminder_1h' THEN 0
    WHEN t.trigger_type = 'appointment_cancelled' THEN 0
    ELSE 0
  END,
  true
FROM public.whatsapp_templates t
WHERE t.barbershop_id = '9ccfd4a2-3bc1-41be-933b-51e94d0dc29a'
AND t.trigger_type IS NOT NULL;
